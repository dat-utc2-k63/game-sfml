...
FallingObjects::FallingObjects() {
    appleTexture.loadFromFile("../gameCplus/image/apple1.jpeg");
    durianTexture.loadFromFile("../gameCplus/image/saurieng1.jpeg");
    boomTexture.loadFromFile("../gameCplus/image/boom1.jpeg");
    ...
    // Initialize font
    font.loadFromFile("../gameCplus/ttf/Roboto-Regular.ttf");

    // Create text objects for lives and score
